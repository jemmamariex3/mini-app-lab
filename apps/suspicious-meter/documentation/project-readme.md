...
- File: `README.md`
- Path: `apps/suspicious-meter/README.md`

## Purpose

Provides a lightweight project overview for Suspicious Meter, displays the local UI preview image stored in the app's `assets` folder, and explains how to run the app locally.
...
- Relative image path `./assets/suspicious.png`
...
- Gives a concise explanation of how the app analyzes text and returns a suspicion score, verdict, and signals
- Explains how to install dependencies, start Expo, and open the app on a device or simulator

## Dependencies Used

- Markdown rendering on GitHub
- Local asset file at `assets/suspicious.png`
